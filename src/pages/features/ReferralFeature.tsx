  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="site-container relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2.5 border border-[rgb(var(--brand-rgb)/0.25)] mb-6">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[2.75rem] font-display font-bold leading-[1.15] mb-5 tracking-tight" style={{ color: "#1b181f" }}>
                ...
                <span style={{ color: "var(--brand)" }}>{t("life-long fans", "जीवन भर के फैन")}</span>
      ...
      <section className="section-spacing bg-white relative">
        ...
        <div className="site-container relative">
          <div className="grid sm:grid-cols-3 gap-5 lg:gap-6 mb-14 lg:mb-20">
            {[
              { value: "35%", labelEN: "More customers", labelHI: "ज्यादा ग्राहक", descEN: "Referrals contribute to 35% of new sales or customers", descHI: "रेफरल नई बिक्री या ग्राहकों का 35% योगदान करते हैं", bg: "bg-gradient-to-br from-[rgb(var(--brand-rgb)/0.15)] to-[rgb(var(--brand-rgb)/0.05)]", border: "border-[rgb(var(--brand-rgb)/0.2)]", color: "var(--brand)" },
          ...
          <motion.h2 initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-center max-w-4xl mx-auto mb-14 lg:mb-20 leading-snug" style={{ color: "#1b181f" }}>
            ...
            <span className="bg-gradient-to-r from-[var(--brand)] to-[#0ea5e9] bg-clip-text text-transparent">{t("word-of-mouth strategy", "वर्ड-ऑफ-माउथ स्ट्रैटेजी")}</span>
          </motion.h2>
            ...
            >
              ...
              <div className={`${block.imageFirst ? "order-1 lg:order-2" : "order-1 lg:order-1"} text-center lg:text-left`}>
                <div className="inline-flex items-center rounded-full px-5 py-2.5 mb-3 bg-white/90 border border-[rgb(var(--brand-rgb)/0.25)] shadow-sm">
                  <span className="text-sm font-semibold" style={{ color: "var(--brand)" }}>{t(block.pillEN, block.pillHI)}</span>
                </div>
      ...
      <section className="section-spacing bg-white border-t border-border relative overflow-hidden">
        ...
        <div className="site-container relative">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto text-center rounded-2xl p-8 lg:p-12 bg-gradient-to-br from-[rgb(var(--brand-rgb)/0.15)] via-primary/25 to-[rgb(var(--brand-rgb)/0.1)] border border-[rgb(var(--brand-rgb)/0.25)] shadow-xl shadow-[rgb(var(--brand-rgb)/0.1)] relative overflow-hidden">
