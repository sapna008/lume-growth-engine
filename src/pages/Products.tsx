...
export default function Products() {
  ...
  const whoIsLumeFor = [
    ...
    return (
      ...
      {/* 1. PRODUCT HERO */}
      <section id="overview" className="pt-20 lg:pt-24 pb-12 lg:pb-16 bg-gradient-to-b from-white via-[var(--brand-tint)]/30 to-white">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {whoIsLumeFor.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-[rgb(var(--brand-rgb)/0.3)]"
              >
